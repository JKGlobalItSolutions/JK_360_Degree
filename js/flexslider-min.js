		...
		$(".hm_circle_progressbar").each(function(index, element) {
			...
			//if ( $.isFunction($.fn.ProgressBar) ) {
				$(this).appear(function() {
					...
					var hm_startColor = $(this).attr("data-start-color") ? $(this).attr("data-start-color") : '#0C7AF7';
					var hm_endColor = $(this).attr("data-end-color") ? $(this).attr("data-end-color") : '#0C7AF7';
